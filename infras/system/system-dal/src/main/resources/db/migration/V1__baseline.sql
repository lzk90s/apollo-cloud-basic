...
CREATE TABLE `t_user`  (
  ...
  `app` varchar(32) NOT NULL DEFAULT '' COMMENT '用户使用的app',
...
INSERT INTO `t_user` VALUES (1, 'admin', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '', '', 1, 'admin@test.com', '2018-09-01 00:00:00', '2018-09-01 00:00:00');
INSERT INTO `t_user` VALUES (2, 'demo', 'demo', 'e10adc3949ba59abbe56e057f20f883e', '', '', 1, 'demo@test.com', '2018-09-01 00:00:00', '2018-09-01 00:00:00');
